...
- **one context's market inputs are market, the cycle that uses them is orchestration** (PR7e-2).
  ...
  market data would belong with the door's other checks, in risk, not here. ``attach_mining_legs``, the
  frame a spec is backtested on, followed in PR7e-5: it assembles the same legs and reads nothing
  above market.
