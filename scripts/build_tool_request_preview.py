...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a review-only Tool Request packet from a complete draft")
    ...
    print("Review-only Tool Request created; no Tool execution or executor handoff occurred")
    return 0
