...
(PR6): SOFT, the default, and `hard`, which only the authenticated operator loosens and `/resume`
clears; `CRYPTO_LIVE_EXECUTION_V0.1.md`, "Standing controls", has the rules. Over Telegram it
