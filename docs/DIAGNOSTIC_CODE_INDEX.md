...
| `a pooled backtest needs at least one snapshot or frame` | `ValueError` | `runtime/mvp_runtime/crypto/factory.py` | 3226 | `backtest_spec_pooled` | `not snapshots and (not frames)` |
...
| `direction_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3581 | `fuse_specs` | `first.direction != second.direction` |
...
| `holdout_unjudgeable` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3603 | `fuse_specs` | `len(conditions) > MAX_FUSION_ENTRY_CONDITIONS` |
...
| `non_and_parent` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3589 | `fuse_specs` | `'OR' in (first.entry_rules.operator, second.entry_rules.operator)` |
...
| `replay frame was built under a different cost model than this backtest charges; the carry series would price trades at rates they never faced` | `ValueError` | `runtime/mvp_runtime/crypto/factory.py` | 3236 | `backtest_spec_pooled` | `frame.cost != cost` |
...
| `schema_version_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3570 | `fuse_specs` | `first.schema_version != second.schema_version` |
| `stop_model_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3587 | `fuse_specs` | `first.exit_rules.stop_model != second.exit_rules.stop_model` |
...
| `symbol_scope_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3585 | `fuse_specs` | `sorted(first.symbol_scope) != sorted(second.symbol_scope)` |
| `timeframe_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3583 | `fuse_specs` | `first.timeframe != second.timeframe` |
| `too_many_conditions` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3597 | `fuse_specs` | `len(conditions) > MAX_ENTRY_CONDITIONS` |
| `venue_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3579 | `fuse_specs` | `first.venue != second.venue` |
