...
- **605** distinct codes across **1162** raise sites
...
| `CONTROL_VERB_NOT_GRANTED` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 746 | `apply_command` | `command in POLICY_GATED_COMMANDS and command not in granted_emergency_controls()` |
| `CONTROL_WRITE_FAILED` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 616 | `save` | `—` |
...
| `LEDGER_UNREADABLE` | `PersistenceError` | `runtime/mvp_runtime/control.py` | 583 | `_mode_from_ledger` | `—` |
...
| `UNKNOWN_COMMAND` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 737 | `apply_command` | `command not in COMMANDS` |
...
| `UNKNOWN_HALT_LEVEL` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 739 | `apply_command` | `halt_level is not None and (command != CMD_HALT_TRADING or halt_level not in HALT_LEVELS)` |
