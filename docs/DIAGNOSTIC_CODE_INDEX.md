...
- **488** distinct codes across **923** raise sites
...
| `ALREADY_CONSUMED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 324 | `build_consumed_record` | `status == STATUS_CONSUMED` |
...
| `APPROVAL_EXPIRED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 248 | `record_decision` | `is_expired(approval, now=now)` |
| `APPROVAL_EXPIRED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 594 | `apply_command` | `approval.get('status') == STATUS_PENDING and is_expired(approval, now=now)` |
...
| `APPROVAL_SCHEMA_INVALID` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 116 | `_validate` | `—` |
| `APPROVAL_SEMANTICS_INVALID` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 121 | `_validate` | `issues` |
...
| `CANDIDATES_TAMPERED` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1786 | `read_candidates` | `not isinstance(stored, str) or integrity.sha256_record(body) != stored` |
| `CANDIDATES_UNREADABLE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1774 | `read_candidates` | `—` |
| `CANDIDATE_AMBIGUOUS` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1411 | `resolve_candidates` | `ambiguous` |
| `CANDIDATE_BEHAVIOUR_CLUSTER_OCCUPIED` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1115 | `assert_no_cluster_siblings` | `—` |
| `CANDIDATE_BELOW_OBSERVATION_ENTRY_BAR` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1216 | `assert_observation_entry_bar` | `—` |
| `CANDIDATE_COST_BASIS_STALE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 341 | `assert_promotable_cost_basis` | `stale` |
| `CANDIDATE_DERIVATION_NOT_PROMOTABLE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1372 | `assert_promotable_derivation` | `refused` |
...
| `CANDIDATE_FAMILY_CAP_EXCEEDED` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1259 | `assert_family_cap` | `—` |
...
| `CANDIDATE_LINEAGE_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1317 | `validate_candidate_lineage` | `not has_type` |
| `CANDIDATE_LINEAGE_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1319 | `validate_candidate_lineage` | `derivation not in DERIVATION_TYPES` |
| `CANDIDATE_LINEAGE_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1322 | `validate_candidate_lineage` | `not isinstance(parents, list) or not all((isinstance(p, str) and p for p in parents))` |
| `CANDIDATE_LINEAGE_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1324 | `validate_candidate_lineage` | `len(set(parents)) != len(parents)` |
| `CANDIDATE_LINEAGE_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1327 | `validate_candidate_lineage` | `len(parents) < lo or (hi is not None and len(parents) > hi)` |
...
| `CORRECTION_AMBIGUOUS` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 323 | `apply_corrections` | `target_id in targets` |
| `CORRECTION_ARITHMETIC_DISAGREES` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 237 | `verify_correction` | `recomputed is None` |
| `CORRECTION_ARITHMETIC_DISAGREES` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 243 | `verify_correction` | `abs(float(correction['corrected_realized_pnl_usdt']) - realized) > tolerance` |
| `CORRECTION_ARITHMETIC_DISAGREES` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 251 | `verify_correction` | `abs(float(correction['corrected_result_R']) - result_r) > tolerance / risk` |
| `CORRECTION_ARITHMETIC_DISAGREES` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 386 | `build_correction` | `recomputed is None` |
| `CORRECTION_TARGET_CHANGED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 228 | `verify_correction` | `target.get('record_sha256') != correction['corrects_record_sha256']` |
| `CORRECTION_TARGET_MISSING` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 224 | `verify_correction` | `target is None` |
| `CORRECTION_UNAPPROVED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 274 | `_verify_approval` | `not isinstance(approval_id, str) or not approval_id` |
| `CORRECTION_UNAPPROVED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 277 | `_verify_approval` | `approvals is None` |
| `CORRECTION_UNAPPROVED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 282 | `_verify_approval` | `approval is None` |
| `CORRECTION_UNAPPROVED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 284 | `_verify_approval` | `approval.get('status') != 'APPROVED'` |
| `CORRECTION_UNAPPROVED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 288 | `_verify_approval` | `snapshot.get('action_type') != CORRECTION_ACTION_TYPE` |
| `CORRECTION_UNAPPROVED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 292 | `_verify_approval` | `snapshot.get('content_sha256') != content_sha256(correction)` |
...
| `DECISION_EXPIRED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 177 | `build_approval_request` | `expires <= issued` |
...
| `DUPLICATE_SELECTOR` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1418 | `resolve_candidates` | `record['candidate_id'] in seen` |
...
| `INVALID_TTL` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 165 | `build_approval_request` | `requested < 1` |
...
| `LIFECYCLE_DECISION_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1710 | `update_statuses` | `not (isinstance(strategy_id, str) and strategy_id and isinstance(new_status, str))` |
...
| `LIFECYCLE_TERMINAL_IMMUTABLE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1715 | `update_statuses` | `str(entry.get('status')) in TERMINAL_STATUSES` |
| `LIFECYCLE_TERMINAL_IMMUTABLE` | `ApprovalBlocked` | `runtime/mvp_runtime/crypto/retirement.py` | 80 | `resolve_pool_entries` | `terminal` |
| `LIFECYCLE_UNKNOWN_STRATEGY` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1713 | `update_statuses` | `entry is None` |
...
| `LIVE_CORRECTIONS_UNREADABLE` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 150 | `read_corrections` | `—` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 91 | `_validate_shape` | `missing` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 95 | `_validate_shape` | `unknown` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 98 | `_validate_shape` | `record['schema_version'] != SCHEMA_VERSION` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 101 | `_validate_shape` | `record['disposition'] not in (VOID, SUPERSEDE)` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 109 | `_validate_shape` | `record['basis'] == ATTESTED` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 113 | `_validate_shape` | `record['basis'] != DERIVED` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 118 | `_validate_shape` | `supplied != _SUPERSEDE_ONLY` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 123 | `_validate_shape` | `not isinstance(value, (int, float)) or isinstance(value, bool)` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 128 | `_validate_shape` | `supplied` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 154 | `read_corrections` | `not isinstance(record, dict)` |
| `LIVE_CORRECTION_SCHEMA_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 365 | `build_correction` | `disposition not in (VOID, SUPERSEDE)` |
| `LIVE_CORRECTION_TAMPERED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 159 | `read_corrections` | `not isinstance(stored, str) or integrity.sha256_record(body) != stored` |
| `LIVE_CORRECTION_TAMPERED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 161 | `read_corrections` | `record['previous_record_sha256'] != previous` |
| `LIVE_CORRECTION_TAMPERED` | `ToolError` | `runtime/mvp_runtime/crypto/live_correction.py` | 169 | `read_corrections` | `correction_id in seen_ids` |
...
| `NOT_APPROVAL_REQUIRED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 153 | `build_approval_request` | `decision != 'APPROVAL_REQUIRED'` |
| `NOT_APPROVED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 326 | `build_consumed_record` | `status != STATUS_APPROVED` |
...
| `NOT_EXPIRED` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 293 | `expire` | `not is_expired(approval, now=now)` |
...
| `NOT_PENDING` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 96 | `_require_pending` | `status != STATUS_PENDING` |
...
| `NO_APPROVAL_ID` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 159 | `build_approval_request` | `not (isinstance(approval_id, str) and approval_id.startswith('approval_'))` |
| `NO_APPROVAL_ID` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 572 | `apply_command` | `not approval_id` |
| `NO_BOT_TOKEN` | `OperatorBlocked` | `runtime/mvp_runtime/operator.py` | 1007 | `_assert` | `not token` |
| `NO_CONSUMPTION_REF` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 330 | `build_consumed_record` | `not (isinstance(consumption_ref, str) and consumption_ref.strip())` |
| `NO_DECISION_REASON` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 265 | `record_decision` | `not (isinstance(reason, str) and reason.strip())` |
...
| `NO_VERIFICATION_REF` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 263 | `record_decision` | `not (isinstance(verification.verification_ref, str) and verification.verification_ref.strip())` |
...
| `PERMISSION_DECISION_MISSING` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 581 | `apply_command` | `permission_decision is None` |
...
| `POLICY_UNAVAILABLE` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 105 | `_policy` | `—` |
...
| `STRATEGY_POOL_DUPLICATE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1445 | `assert_pool_identity_unique` | `strategy_id in seen_strategy` |
| `STRATEGY_POOL_DUPLICATE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1450 | `assert_pool_identity_unique` | `candidate_id in seen_candidate` |
| `STRATEGY_POOL_INVALID` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1466 | `load_active_pool` | `—` |
| `STRATEGY_POOL_UNREADABLE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1462 | `load_active_pool` | `—` |
...
| `TTL_EXCEEDS_POLICY` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 167 | `build_approval_request` | `requested > policy_max` |
...
| `UNKNOWN_APPROVAL` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 577 | `apply_command` | `approval is None` |
...
| `UNKNOWN_CANDIDATE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1409 | `resolve_candidates` | `missing` |
| `UNKNOWN_COMMAND` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 569 | `apply_command` | `verb not in COMMANDS` |
...
| `UNKNOWN_PARENT_CANDIDATE` | `ToolError` | `runtime/mvp_runtime/crypto/pool.py` | 1333 | `validate_candidate_lineage` | `unknown` |
...
| `UNVERIFIED_SOURCE` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 258 | `record_decision` | `verification.method != TELEGRAM_VERIFICATION_METHOD` |
...
| `WRONG_APPROVER` | `ApprovalBlocked` | `runtime/mvp_runtime/approval.py` | 253 | `record_decision` | `verification.approved_by != REQUIRED_APPROVER` |
| `direction_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3962 | `fuse_specs` | `first.direction != second.direction` |
| `holdout_unjudgeable` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3984 | `fuse_specs` | `len(conditions) > MAX_FUSION_ENTRY_CONDITIONS` |
| `non_and_parent` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3970 | `fuse_specs` | `'OR' in (first.entry_rules.operator, second.entry_rules.operator)` |
| `schema_version_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3951 | `fuse_specs` | `first.schema_version != second.schema_version` |
| `stop_model_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3968 | `fuse_specs` | `first.exit_rules.stop_model != second.exit_rules.stop_model` |
| `symbol_scope_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3966 | `fuse_specs` | `sorted(first.symbol_scope) != sorted(second.symbol_scope)` |
| `timeframe_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3964 | `fuse_specs` | `first.timeframe != second.timeframe` |
| `too_many_conditions` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3978 | `fuse_specs` | `len(conditions) > MAX_ENTRY_CONDITIONS` |
| `venue_mismatch` | `FusionRefused` | `runtime/mvp_runtime/crypto/factory.py` | 3960 | `fuse_specs` | `first.venue != second.venue` |
