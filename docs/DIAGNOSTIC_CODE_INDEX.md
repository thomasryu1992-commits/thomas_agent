...
- **492** distinct codes across **922** raise sites
...
| `CANDIDATE_UNCONFIRMED_FOR_LIVE` | `ToolError` | `runtime/mvp_runtime/crypto/forward_confirmation.py` | 255 | `assert_live_tier_confirmed` | `—` |
