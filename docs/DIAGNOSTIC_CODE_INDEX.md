...
| `ARGUMENT_NOT_ACCEPTED` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 768 | `apply_command` | `expected_state is not None and command != CMD_RESUME` |
...
| `CONTROL_STATE_CHANGED` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 1012 | `apply_command` | `latest != baseline` |
| `CONTROL_VERB_NOT_GRANTED` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 773 | `apply_command` | `command in POLICY_GATED_COMMANDS and command not in granted_emergency_controls()` |
| `CONTROL_WRITE_FAILED` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 629 | `save` | `—` |
...
| `LEDGER_UNREADABLE` | `PersistenceError` | `runtime/mvp_runtime/control.py` | 596 | `_mode_from_ledger` | `—` |
...
| `MISSING_TASK_ID` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 809 | `apply_command` | `not (isinstance(arg, str) and arg.strip())` |
...
| `UNKNOWN_COMMAND` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 761 | `apply_command` | `command not in COMMANDS` |
...
| `UNKNOWN_HALT_LEVEL` | `ControlBlocked` | `runtime/mvp_runtime/control.py` | 764 | `apply_command` | `halt_level is not None and (command != CMD_HALT_TRADING or not isinstance(halt_level, str) or h…` |
