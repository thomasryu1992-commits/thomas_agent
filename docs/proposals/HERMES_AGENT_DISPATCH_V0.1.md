...
**상태:** IMPLEMENTED 2026-08-30 — 문, P3 allowlist, 키 없음, 귀속은 출시됐고 §6-6 정책 블록(policy 1.3.0)과 $50/일
알림(`dispatch_spend`)이 2026-08-30에 이행됐다. 열린 결정은 없다(무료 티어라 알림은 휴면).
...
>
> **즉 능력은 배포됐고 그것을 기록·계측하기로 한 조문은 배포되지 않았다**(2026-08-22 기준 — 2026-08-30에 이행, 위 표). 이 비대칭 자체가
