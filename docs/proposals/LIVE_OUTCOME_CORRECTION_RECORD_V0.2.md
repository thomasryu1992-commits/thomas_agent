...
**상태:** IMPLEMENTED 2026-08-24 — 구현·실행됨. `crypto/live_correction.py`, 첫 정정 레코드
`live_corr_1710c5ca552d3e88c668`가 2026-08-24T14:20Z에 실행됐다(`docs/REMAINING_WORK.md` 헤더, §C).
날짜는 실행일이다.
**원래 상태(작성 당시, 2026-09-25에 위로 정정):** DRAFT — 설계 선행(구현 아님). 코드 변경 없음. **v0.1을 대체한다.**
