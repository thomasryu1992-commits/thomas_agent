...
- [x] **After PR5 — door API v2** (design record PROPOSED 2026-09-04: [`DOOR_API_V2_DESIGN_V0.1.md`](runtime-contracts/DOOR_API_V2_DESIGN_V0.1.md); PR7 frame **done 2026-09-04** → PR8 registry AGENT **done 2026-09-04** → PR9 idempotency **done 2026-09-04** → PR10 read verbs **done 2026-09-04** → PR11 mirroring **done 2026-09-04**; the runtime side of the record is complete. Hermes-side shim v2 **live on the host 2026-09-04** (`/root/hermes-trial/data/mcp/thomas_door_client.py` + four shims, SOUL/skill 1.3.0, cron toolsets without `thomas-switch` — host state, recorded in the harness ops notes). policy **1.5.0 applied and deployed 2026-09-04** (#839, `candidate-839`); Q7-a's policy fingerprint **done 2026-09-04** (`policy_fingerprint`, startup banner per service + one operator notice on change). The sequence is complete) (typed/versioned frame, `task_registry` origin `AGENT` after a load
