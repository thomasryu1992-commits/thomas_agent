...
- [ ] **After PR5 — door API v2** (design record PROPOSED 2026-09-04: [`DOOR_API_V2_DESIGN_V0.1.md`](runtime-contracts/DOOR_API_V2_DESIGN_V0.1.md); PR7 frame **done 2026-09-04** → PR8 registry AGENT → PR9 idempotency → PR10 read verbs → PR11 mirroring, then shim v2 and policy 1.5.0) (typed/versioned frame, `task_registry` origin `AGENT` after a load
