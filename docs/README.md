...
| **Hermes as orchestrator — decided architecture, the eight invariants, and the PR sequences** (2026-09-03, amended 2026-09-14 with the workflow manager decisions) | [Hermes Orchestrator Architecture V0.2](HERMES_ORCHESTRATOR_ARCHITECTURE_V0.2.md) |
